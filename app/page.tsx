      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
        <div className="container mx-auto px-4 flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-2">
            ...
            <span className="text-xl font-bold text-foreground">Navyan Tech</span>
          </Link>
          ...
          <div className="container mx-auto px-4">
            <nav className="flex items-center justify-center space-x-8 py-3">
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2">
                    ...
                    <Link href="/category/mini-pcs" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Mini PCs
                    </Link>
                    <Link
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2">
                    ...
                    <Link href="/category/memory" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Memory & Storage
                    </Link>
                  </div>
                </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2">
                    ...
                    <Link href="/category/headsets" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Gaming Headsets
                    </Link>
                  </div>
                </div>
              ...
              <div className="relative group">
                ...
                <div className="absolute top-full left-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                  <div className="py-2">
                    <Link href="/category/monitors" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Monitors
                    </Link>
                    <Link href="/category/speakers" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Speakers
                    </Link>
                    <Link href="/category/webcams" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Webcams
                    </Link>
                    <Link href="/category/cables" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                      Cables & Adapters
                    </Link>
                  </div>
                </div>
      ...
      <footer className="bg-card border-t border-border py-16">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="space-y-4">
              <Link href="/" className="flex items-center space-x-2">
                ...
                <span className="text-2xl font-bold font-serif text-foreground">TechStore</span>
              </Link>
          ...
          <div className="border-t border-border mt-12 pt-8 text-center text-muted-foreground">
            <p>&copy; 2025 TechStore. All rights reserved. Built with precision and passion.</p>
          </div>
        </div>
      </footer>
    </div>
