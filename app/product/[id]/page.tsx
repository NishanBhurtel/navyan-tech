...
function getProductData(id: string) {
  ...
  const products = {
    ...
    "3": {
      ...
      display: "15.6-inch, Full HD (1920 x 1080), IPS-level Panel, 144Hz refresh rate, 45% NTSC color gamut",
      os: "Windows 11 Home",
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-6">
            <div>
              <Badge className="mb-3 bg-primary/10 text-primary border-primary/20">Ends in: 9d 1h 48m 50s</Badge>
          ...
          <Tabs defaultValue="specifications" className="w-full">
            ...
            <TabsContent value="specifications" className="space-y-6">
              <div className="bg-card rounded-xl border border-border p-6">
                <h3 className="text-2xl font-bold font-serif text-foreground mb-6">Technical Specifications</h3>
            ...
            <TabsContent value="description" className="space-y-6">
              <div className="bg-card rounded-xl border border-border p-6">
                <h3 className="text-2xl font-bold font-serif text-foreground mb-6">Product Description</h3>
            ...
            <TabsContent value="reviews" className="space-y-6">
              <div className="bg-card rounded-xl border border-border p-6">
                <h3 className="text-2xl font-bold font-serif text-foreground mb-6">Customer Reviews</h3>
        ...
        <div className="mt-16">
          <h3 className="text-3xl font-bold font-serif text-foreground mb-8">You may also like</h3>
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">{relatedProduct.specs}</p>
                    </div>
                    ...
                    <div className="flex items-center space-x-2">
                      <span className="text-xl font-bold font-serif text-foreground">{relatedProduct.price}</span>
                    ...
                    <div className="flex gap-2">
                      <Link href={`/product/${relatedProduct.id}`} className="flex-1">
