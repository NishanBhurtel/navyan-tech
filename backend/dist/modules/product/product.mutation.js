...
exports.productMutationHandler = exports.removeProduct = exports.updateProductDetails = exports.createProduct = void 0;
const product_repository_1 = __importDefault(require("../../repository/mangodb/product/product.repository"));
const createProduct = async ({ req, res }) => {
    try {
        const { name, images, discountedPrice, originalPrice, brand, isFeatured, categoryID, subCategoryID, description, stock, specifications, technicalSpecification, } = req.body;
...
const updateProductDetails = async ({ req }) => {
    try {
        ...
        const { name, images, discountedPrice, originalPrice, brand, isFeatured, stock, description, categoryID, specifications, technicalSpecification, // ✅ expect nested object
         } = req.body;
