import { AppRoute, AppRouteDeleteNoBody, AppRouteMutation, AppRouteQuery, AppRouter, FlattenAppRouter, ServerInferRequest, ServerInferResponseBody, ServerInferResponses } from '@ts-rest/core';
import { Express, NextFunction, Response, Request } from 'express-serve-static-core';
import { RequestValidationError } from './request-validation-error';
export type AppRouteQueryImplementation<T extends AppRouteQuery | AppRouteDeleteNoBody> = (input: ServerInferRequest<T, Express['request']['headers']> & {
    req: TsRestRequest<T>;
    res: Response;
...
export type AppRouteImplementation<T extends AppRoute> = T extends AppRouteMutation ? AppRouteMutationImplementation<T> : T extends AppRouteQuery | AppRouteDeleteNoBody ? AppRouteQueryImplementation<T> : never;
...
export interface AppRouteOptions<TRoute extends AppRoute> {
    ...
    handler: TRoute extends AppRouteQuery | AppRouteDeleteNoBody ? AppRouteQueryImplementation<TRoute> : TRoute extends AppRouteMutation ? AppRouteMutationImplementation<TRoute> : never;
}
